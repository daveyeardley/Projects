...
*                 saving and loading of images. This file contains constructor and events for the 
*                 About Box.
*/
...
namespace SETPaint
{
    partial class AboutBox : Form
    {
        /*
        * METHOD       : AboutBox()
        * DESCRIPTION  : This is the constructor for the About Box.
        * PARAMETERS   : none
        * RETURNS      : none
        */
        public AboutBox()
         ...
         * DESCRIPTION  : This closes the About Box window when a click even on the OK box
         *                is received.
         * PARAMETERS   : object sender     - the OK button control
         *                EventArgs e       - the click event
         * RETURNS      : none
         */
